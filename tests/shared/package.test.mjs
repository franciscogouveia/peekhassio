...
test('packages every module imported by the preferences entry point', async () => {
    ...
    assert.deepEqual(modules, ['entities/configuration.js', 'entities/preferences.js', 'entities/state-client.js', 'entities/view.js', 'extension.js', 'groups/configuration.js', 'groups/panel-renderer.js', 'groups/panel-view.js', 'groups/preferences.js', 'groups/view.js', 'instances/configuration.js', 'instances/credential-store.js', 'instances/home-assistant-client.js', 'instances/preferences.js', 'instances/secret-service.js', 'instances/soup-websocket-transport.js', 'instances/view.js', 'prefs.js', 'runtime/coordinator.js', 'runtime/extension-runtime.js', 'shared/action-runner.js', 'shared/configuration.js', 'shared/signal-owner.js']);
    assert.deepEqual(extraSources, ['entities', 'groups', 'instances', 'runtime', 'shared']);
